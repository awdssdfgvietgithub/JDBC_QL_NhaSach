...
public class KhachHang_gui extends javax.swing.JInternalFrame {
    ...
    public KhachHang_gui() {
        ...
        String[] tieuDeKH = {"Mã khách hàng", "Tên kh", "Số điện thoại", "Email", "Giảm giá", "Loại thẻ", "Điểm"};
    ...
    private void tbKHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKHMouseClicked
        ...
        txtGiamGia.setText((String) String.valueOf(tbKH.getValueAt(row, 4)));
        txt_capBac.setText((String) String.valueOf(tbKH.getValueAt(row, 5)));
        txtDiem.setText((String) String.valueOf(tbKH.getValueAt(row, 6)));
...
//        txtMail.setEnabled(true);
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        try {
            ...
            String giam = txtGiamGia.getText();
            String capbac = txt_capBac.getText();
            ...
            kh.setEmail(email);
            kh.setGiamGia(giam);
            kh.setLoaiThe(capbac);
            kh.setSoDiem(diem);
            if (txtMaKH.getText().isEmpty() || txtTenKh.getText().isEmpty() || txtSDT.getText().isEmpty() || txtMail.getText().isEmpty()) {
                txtMaKH.requestFocus();
...
//    }
    ...
    private void btnXuatTheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatTheActionPerformed
        ...
        try {
            ...
            bw.newLine();
            bw.write("Cấp bậc: " + kh.getLoaiThe());
            bw.newLine();
            ...
            bw.newLine();
            bw.write("Giảm giá: " + kh.getGiamGia());
            bw.newLine();
            bw.write("Số điểm: " + kh.getSoDiem());
            bw.close();
            fw.close();
